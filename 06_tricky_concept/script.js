...
//! HOISTING IN JAVASCRIPT- it is never used in modern Js but is important topic in interview

var hoist;
console.log(hoist);
hoist = "Th variable has been hoisted";
// undefined - only if both var hoist and hoist is at top we will get output
